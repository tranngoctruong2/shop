const Contact = () => {
    return (  <>
    <div className=" w-full max-w-screen-2xl h-[350px] bg-[#1d1f2e] flex flex-col justify-center items-center mb-24">
        ...
        <div className="text-4xl text-white mb-6">SHop Email</div>
        <div className="tqd-form">
          <div className="flex flex-col md:flex-row justify-center items-center gap-3">
            ...
            <div className="">
              <button type="submit" className="text-center uppercase tracking-wider py-4 px-8 text-[13px] font-semibold cursor-pointer shadow-xl rounded hover:bg-opacity-95 bg-white text-gray-900 w-max max-h-[54px]">Subscribe</button>
            </div>
          </div>
        </div>
      </div>
